...
Steering combines device gyroscope and accelerometer input, falling back to the default `ui_left` / `ui_right` keyboard actions on desktop. After game over, press `ui_accept` or tap/click to restart.
